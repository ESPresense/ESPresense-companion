<script lang="ts">
	...
	import { showCustomModal, showAlert } from '$lib/modalUtils';
	...
	async function handleEdit() {
		...
		try {
			...
			showCustomModal(DeviceSettingsModal, {
				deviceSetting,
				parent: null // Remove parent reference as it's not needed in new system
			});
		} catch (ex) {

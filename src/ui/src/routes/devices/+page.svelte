	...
	<div class="flex justify-between items-center my-2 px-2">
		...
		<div class="flex items-center space-x-4">
			<div class="flex items-center space-x-3">
				<button class="relative inline-flex h-6 w-11 items-center rounded-full transition-colors bg-slate-600" on:click={toggleShowAll} aria-label="Toggle show all devices">

...
public class RxAdjOptimizer : IOptimizer
{
    private readonly State _state;
    //private readonly GaussianWeighting _weighting;

    public RxAdjOptimizer(State state)
    {
        _state = state;
    }

    public (double rxAdj, double absorption, double error)? Optimize(Node node, NodeSettings? ns)
    {
